    ...
    <div className="lg:w-11/12 mx-auto px-3 xl:px-0">
        ...
        <li className="flex items-center justify-between">
          <div className="flex flex-col lg:flex-row w-full space-x-4">
              ...
              <div className='border lg:w-[18rem] w-full'>
                <a href="/health">
                  ...
                  <div className='p-3 border-t'>
                    ...
                    <p className='text-black/70 break-all text-[0.875rem] hover:text-blue-800'>
                    ...
                    <p className='text-black hover:text-blue-800 text-[0.75rem] font-bold pt-5'>Kaia Hubbard</p>
                  </div>
                </a>
              </div>
              <div className='border lg:w-[18rem] w-full'>
                <div className='p-3'>
                  <a href="/Bathroom">
                    ...
                    <p className='text-black text-[0.75rem] font-bold pt-5 hover:text-blue-800'>Claire Hansen</p>
                  </a>

                  <div className=' space-y-3 py-2 pt-10 pb-4'>
                    <div className='flex space-x-2 cursor-pointer'>
                      <img className='h-12 w-12 object-cover rounded-lg' src="/images/trump.jpg" alt="" />
                      <p className='text-black/80 hover:text-blue-800'>
            ...
            <a href="/health" className='lg:pt-5 pt-2 order-1 lg:-order-2'>
              <div className="bg-cover bg-no-repeat bg-right h-[440px] group cursor-pointer relative" style={{ backgroundImage: `url("/images/gettyimages.jpg")` }}>
                <div className="">
                  <div className=" absolute position bottom-36 lg:bottom-[8rem] xl:bottom-24 pl-3">
                    ...
                    <h1 className="text-white lg:text-[32px] text-[28px] font-bold">
                      Putin Poised to <br /> Shake Down <br /> Oligarchs
                    </h1>
              ...
              <div className="py-2 grid grid-cols-1 gap-4">
                <div className="py-2 space-y-2 border border-gray-300 text-center px-5 cursor-pointer">
                  <h1 className="text-[12px] text-gray-500 font-bold text-center hover:text-blue-800">NATIONl NEWS</h1>
                  <h1 className="text-[20px] font-bold hover:text-blue-800 text-black">Santos Confession Doesn’t Quiet Calls to step Dowin</h1>
                  <p className="text-[14px] text-gray-700 font-semibold break-all hover:text-blue-800">The disgraced politician hasn’t even taken office, but he’s facing an overwhelming wave of calls for his resignation after he admitted to a pattern of lying about virtually every aspect of his life.
                  </p>
                </div>
                <div className="py-2 space-y-2 border border-gray-300 text-center px-5 cursor-pointer">
                  <h1 className="text-[12px] text-gray-500 font-bold text-center hover:text-blue-800">NATIONl NEWS</h1>
            ...
            <div className='pt-14 order-3 lg:-order-1 '>
              <div className='border lg:w-[18rem] w-full'>
                <h1 className='text-black text-[1rem] font-semibold py-2 text-center border-t-4 border-[#CE2927]'>RANKINGS & ADVICE</h1>
                <div className='p-3 border-t'>
                  <a href="/Bathroom">
                    <h1 className='text-black hover:text-black/70 cursor-pointer font-semibold text-[1.25rem] hover:text-blue-800'>Annual Credit Card Awards</h1>
              ...
              <div className='border lg:w-[18rem] w-full'>
                <div className='p-3'>
                  ...
                  <div className='space-y-3'>
                    <a href="/health"><p className='text-black/80 text-md hover:text-blue-800 pt-2'>7 Best Water Stocks and ETFs to Buy</p></a>
                    <a href="/health"><p className='text-black/80 text-md hover:text-blue-800'>7 Best Water Stocks and ETFs to Buy</p></a>
                    <a href="/health"><p className='text-black/80 text-md hover:text-blue-800'>7 Best Water Stocks and ETFs to Buy</p></a>
                  </div>
                </div>
                ...
                Process.map((elem) => {
                  ...
                  return (
                    <div className="bg-white p-1 cursor-pointer border flex flex-col-reverse lg:flex-row" >
                      <div className="py-3">
                        <h1 className="text-[12px] font-semibold text-red-600 hover:text-blue-800">{title}</h1>
                        <h1 className="text-[20px] font-semibold hover:text-blue-800">{title}</h1>
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <span className="border border-[#D3D7DC] flex items-center space-x-2 cursor-pointer">
              <p className=" text-[#9297A1] text-[32px] font-bold bg-[#F4F7F9] px-2 py-2 w-fit hover:text-blue-800 border-r border-[#D3D7DC]">2</p>
              <p className="text-[14px] text-[#272A33] hover:text-blue-800">
                Star Rising in Kremlin, Russia's Medvedev Predicts War in West</p>
            </span>
            <span className="border border-[#D3D7DC] flex items-center space-x-2 cursor-pointer">
              <p className=" text-[#9297A1] text-[32px] font-bold bg-[#F4F7F9] px-2 py-2 w-fit hover:text-blue-800 border-r border-[#D3D7DC]">3</p>
              <p className="text-[14px] text-[#272A33] hover:text-blue-800">
                Star Rising in Kremlin, Russia's Medvedev Predicts War in West</p>
            </span>
            <span className="border border-[#D3D7DC] flex items-center space-x-2 cursor-pointer">
              <p className=" text-[#9297A1] text-[32px] font-bold bg-[#F4F7F9] px-2 py-2 w-fit hover:text-blue-800 border-r border-[#D3D7DC]">4</p>
              <p className="text-[14px] text-[#272A33] hover:text-blue-800">
                Star Rising in Kremlin, Russia's Medvedev Predicts War in West</p>
            </span>
            <span className="border border-[#D3D7DC] flex items-center space-x-2 cursor-pointer">
              <p className=" text-[#9297A1] text-[32px] font-bold bg-[#F4F7F9] px-2 py-2 w-fit hover:text-blue-800 border-r border-[#D3D7DC]">5</p>
              <p className="text-[14px] text-[#272A33] hover:text-blue-800">
                Star Rising in Kremlin, Russia's Medvedev Predicts War in West</p>
            </span>
            <span className="border border-[#D3D7DC] flex items-center space-x-2 cursor-pointer">
              <p className=" text-[#9297A1] text-[32px] font-bold bg-[#F4F7F9] px-2 py-2 w-fit hover:text-blue-800 border-r border-[#D3D7DC]">6</p>
              <p className="text-[14px] text-[#272A33] hover:text-blue-800">
                Star Rising in Kremlin, Russia's Medvedev Predicts War in West</p>
            </span>
            <span className="border border-[#D3D7DC] flex items-center space-x-2 cursor-pointer">
              <p className=" text-[#9297A1] text-[32px] font-bold bg-[#F4F7F9] px-2 py-2 w-fit hover:text-blue-800 border-r border-[#D3D7DC]">7</p>
              <p className="text-[14px] text-[#272A33] hover:text-blue-800">
                Star Rising in Kremlin, Russia's Medvedev Predicts War in West</p>
            </span>
            <span className="border border-[#D3D7DC] flex items-center space-x-2 cursor-pointer">
              <p className=" text-[#9297A1] text-[32px] font-bold bg-[#F4F7F9] px-2 py-2 w-fit hover:text-blue-800 border-r border-[#D3D7DC]">8</p>
              <p className="text-[14px] text-[#272A33] hover:text-blue-800">
                Star Rising in Kremlin, Russia's Medvedev Predicts War in West</p>
            </span>
          </div>
      ...
      <div className="grid lg:grid-cols-8 md:grid-cols-4 gap-5 container mx-auto">
        <div className=' space-y-3 py-2 pt-10 col-span-2 h-fit'>
          <div className='flex space-y-3 lg:space-y-0 space-x-2 cursor-pointer items-center'>
            ...
            <p className='text-black/80 text-sm hover:text-blue-800'>
        ...
        <div className=" border hover:shadow-md hover:shadow-gray-500 transition duration-300  bg-white w-fit h-fit flex flex-col lg:flex-row items-center col-span-4 space-x-4">
          ...
          <div className="py-5 lg:py-0 cursor-pointer">
            <p className="text-2xl font-bold hover:text-blue-800">
              How a Gap Year
            </p>
            <p className="text-sm text-black/70 hover:text-blue-800">
              More students are taking a year off after high school to explore their interests.
            </p>
            <p className="text-xs pt-5 hover:text-blue-800">
        ...
        <div className="border rounded-t col-span-2 h-fit w-full mx-auto pb-5 cursor-pointer">
          <div className="bg-[#F4F7F9] border-b-2 border-gray-400">
            ...
            <div>
              <p className="text-lg font-bold text-center hover:text-blue-800">Education Rankings</p>
            </div>
          </div>
          <div className="bg-[#ffffff] px-5 space-y-4 pt-5 cursor-pointer">
            <div className="flex  justify-between">
              <div>
                <p className="text-sm text-black/70 hover:text-blue-800">Colleges</p>
                <p className="text-sm text-black/70 hover:text-blue-800">Grad Schools</p>
                <p className="text-sm text-black/70 hover:text-blue-800">K-12 Schools</p>
              </div>
              <div className="cursor-pointer">
                <p className="text-sm text-black/70 hover:text-blue-800">Global Universities</p>
                <p className="text-sm text-black/70 hover:text-blue-800">Online Programs</p>
              </div>
            </div>
            <p className="text-black font-bold text-xs hover:text-blue-800">SEE ALL EDUCATION RANKINGS »</p>
            <p className="text-black font-bold text-xs hover:text-blue-800">SEE ALL EDUCATION RANKINGS »</p>
          </div>
        </div>
      </div>
      ...
      <div className=" grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 container mx-auto py-5">
        <div className="space-y-3 p-2 border-2">
          ...
          <p className="text-black/90 hover:text-blue-800">
        ...
        <div className="space-y-3 lg:w-[80%] w-full">
          <div className="flex flex-col lg:flex-row border-t-2 border-gray-500 lg:space-x-10 py-1">
            <div className="space-y-3 w-full">
              <a className="a1 text-[#000000] text-xs font-bold text-[20px] hover:text-blue-800" href="">The 10 Worst Presidents</a>
              <div>
              ...
              <p className="text-[14px] text-[#3a3c42] hover:text-blue-800">
                Hospitalization data points to how the flu season is kicking into high gear much earlier than in seasons past.
              </p>
              <p className="text-[12px] text-[#878A96] pt-2 hover:text-blue-800">
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2 xl:pt-40">
            ...
            <span className="border border-[#D3D7DC] flex items-center space-x-2 2xl:w-[40rem]">
              <p className="hover:text-blue-800 text-[#9297A1] text-[32px] font-bold bg-[#F4F7F9] px-2 py-2 w-fit border-r border-[#D3D7DC]">1</p>
              <p className="text-[14px] text-[#272A33] hover:text-blue-800">
                Star Rising in Kremlin, Russia's Medvedev Predicts War in West</p>
            </span>
            <span className="border border-[#D3D7DC] flex items-center space-x-2">
              <p className="hover:text-blue-800 text-[#9297A1] text-[32px] font-bold bg-[#F4F7F9] px-2 py-2 w-fit border-r border-[#D3D7DC]">2</p>
              <p className="text-[14px] text-[#272A33] hover:text-blue-800">
                Star Rising in Kremlin, Russia's Medvedev Predicts War in West</p>
            </span>
            <span className="border border-[#D3D7DC] flex items-center space-x-2">
              <p className="hover:text-blue-800 text-[#9297A1] text-[32px] font-bold bg-[#F4F7F9] px-2 py-2 w-fit border-r border-[#D3D7DC]">3</p>
              <p className="text-[14px] text-[#272A33] hover:text-blue-800">
                Star Rising in Kremlin, Russia's Medvedev Predicts War in West</p>
            </span>
            <span className="border border-[#D3D7DC] flex items-center space-x-2">
              <p className="hover:text-blue-800 text-[#9297A1] text-[32px] font-bold bg-[#F4F7F9] px-2 py-2 w-fit border-r border-[#D3D7DC]">4</p>
              <p className="text-[14px] text-[#272A33] hover:text-blue-800">
                Star Rising in Kremlin, Russia's Medvedev Predicts War in West</p>
            </span>
            <span className="border border-[#D3D7DC] flex items-center space-x-2">
              <p className="hover:text-blue-800 text-[#9297A1] text-[32px] font-bold bg-[#F4F7F9] px-2 py-2 w-fit border-r border-[#D3D7DC]">5</p>
              <p className="text-[14px] text-[#272A33] hover:text-blue-800">
                Star Rising in Kremlin, Russia's Medvedev Predicts War in West</p>
            </span>

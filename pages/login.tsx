      ...
      <div className="bg-white w-7/12 container mx-auto shadow-lg shadow-gray-600 px-5 py-4">
        ...
        <div className="flex items-center justify-center lg:space-x-3">
          ...
          <div className="pt-14 w-full">
            <h1 className="text-[16px] pb-5 font-normal">Sign in with your email and password</h1>
            ...
            <div>
              <a className="text-[14px] text-[#4E8AC0] hover:text-gray-800 hover:underline" href="/forgotPassword">
